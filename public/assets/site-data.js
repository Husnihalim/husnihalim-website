...
(function () {
  ...
  */
  const SITE_COMPANIES = [
    /* ----- logos (major clients) ----- */
    { name: "Intel Technology Sdn Bhd", display: "Intel", logo: "/assets/portfolio/logos/intel-logo.png" },
    { name: "Petronas", display: "Petronas", logo: "/assets/portfolio/logos/petronas-logo.png", tall: true },
    { name: "Safran Landing Systems (M) Sdn Bhd", display: "Safran", logo: "/assets/portfolio/logos/safran-logo.png" },
    { name: "Panasonic Aircond Malaysia", display: "Panasonic", logo: "/assets/portfolio/logos/panasonic-logo.png" },
    { name: "Mitsui High-Tec Malaysia Sdn Bhd", display: "Mitsui High-Tec", logo: "/assets/portfolio/logos/mitsui-logo.png" },
    { name: "Maxeon Solar Technologies", display: "Maxeon", logo: "/assets/portfolio/logos/maxeon-logo.png" },
    { name: "Carotino Sdn Bhd", display: "Carotino", logo: "/assets/portfolio/logos/carotino-logo.png" },
    { name: "Munchy Food Industries Sdn Bhd", display: "Munchy's", logo: "/assets/portfolio/logos/munchys-logo.png" },
    { name: "Inari Technology", display: "Inari", logo: "/assets/portfolio/logos/inari-logo.png" },
    { name: "Datasonic Group Berhad", display: "Datasonic", logo: "/assets/portfolio/logos/datasonic-logo.png" },
    { name: "Sharp TV Manufacturing", display: "Sharp", logo: "/assets/portfolio/logos/sharp-logo.png" },
    { name: "Koito Manufacturing Sdn Bhd", display: "Koito", logo: "/assets/portfolio/logos/koito-logo.png" },
    { name: "HRD Corp Malaysia", display: "HRD Corp", logo: "/assets/portfolio/logos/hrdcorp-logo.png" },
    { name: "Malaysian Automotive Research & Innovation Institute (MARii)", display: "MARii", logo: "/assets/portfolio/logos/marii-logo.png" },
    { name: "TERAJU", display: "TERAJU", logo: "/assets/portfolio/logos/teraju-logo.png" },
    { name: "Sapura Industrial Berhad", display: "Sapura Industrial", logo: "/assets/portfolio/logos/sapura-logo.png" },
